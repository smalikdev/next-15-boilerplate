...
const Ticket: React.FC<TicketProps> = ({
  ...
  return (
    <div className=" p-4 shadow-md bg-white max-w-max h-full">
      ...
      <div className="flex items-center gap-2 mt-4">
        ...
        <div className={`flex items-center justify-center border px-2 py-1 rounded-md  shadow-4 ${priorityClasses}`}>
          <span className="inline-block w-2 h-2 mr-1 bg-red-500 rounded-full"></span>
          <span className="text-black font-medium">
            {priority}
          </span>
        </div>
        <div className="flex items-center border px-2 py-1 rounded-md bg-blue-50 shadow">
          ...
          <span className="text-sm text-black ml-1">{comments}</span>
        </div>

        <div className="flex items-center justify-center border px-2 py-1 rounded-md bg-blue-50 shadow-4 shadow-blue-200">
          <div className="mr-1">
        ...
        <div className="flex items-center justify-center border px-3 py-1 rounded-md bg-blue-50 shadow-4 shadow-blue-200">
      ...
      <div className="mt-4">
        {/* date */}
        <div className="mt-2 text-black font-light text-xs">Today, 23/23/2323</div>

        {/* Name */}
        <div className="mt-2 text-black font-semibold">Andrew Mark</div>

        {/* desc */}
        <div className="mt-4 text-black font-normal">Completed....ask</div>
        <hr className="mt-1" />
      </div>
      ...
      {/* rating  */}
      <div className="mt-4">
        <div className="mt-2 text-black font-semibold">Rate your experience (1-5)</div>
